...
export default function AgradecimentoCondicoesGeraisDeSeguros() {
  return (
    <section className='agradecimento-condicoes-gerais-de-seguros_CTA flex flex-col items-center justify-center bg-background bg-center'>
