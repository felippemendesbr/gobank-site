...
export default function AgradecimentoSegurosEConsorcios() {
  return (
    <section className='agradecimento-seguros-e-consorcios_CTA flex flex-col items-center justify-center bg-background bg-center'>
