...
export default function AgradecimentoGoPag() {
  return (
    <section className='agradecimento-maquininhas-go-pag_CTA flex flex-col items-center justify-center bg-background bg-center'>
