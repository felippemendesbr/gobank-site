...
export default function AgradecimentoSejaUmParceiro() {
  return (
    <section className='agradecimento-seja-um-parceiro_CTA flex flex-col items-center justify-center bg-background bg-center'>
