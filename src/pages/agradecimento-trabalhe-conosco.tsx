...
export default function AgradecimentoTrabalheConosco() {
  return (
    <section className='agradecimento-trabalhe-conosco_CTA flex flex-col items-center justify-center bg-background bg-center'>
      <div className='flex w-full max-w-[1185px] flex-col gap-5 px-5 pb-56 pt-32'>
        <h1 className='text-6xl font-light text-green-go-bank'>Obrigado por querer fazer parte da GoCapital. </h1>
        <p className='text-4xl text-white'>Estamos torcendo para que o seu perfil corresponda a uma de nossas oportunidades!</p>
