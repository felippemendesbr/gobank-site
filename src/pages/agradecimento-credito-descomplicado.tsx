...
export default function AgradecimentoCreditoDescomplicado() {
  return (
    <section className='agradecimento-credito-descomplicado_CTA flex flex-col items-center justify-center bg-background bg-center'>
