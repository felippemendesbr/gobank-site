...
export default function AgradecimentoFinanciamentos() {
  return (
    <section className='agradecimento-financiamentos_CTA flex flex-col items-center justify-center bg-background bg-center'>
